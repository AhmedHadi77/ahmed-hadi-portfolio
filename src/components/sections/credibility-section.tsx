...
export function CredibilitySection() {
  return (
    <section className="section-band bg-white py-10">
        ...
        <Reveal>
          <div className="premium-surface grid gap-4 rounded-lg p-4 sm:grid-cols-2 lg:grid-cols-4">
            {credibilitySignals.map((signal) => (
              <div
                key={signal.label}
                className="group flex min-h-[132px] flex-col justify-between rounded-lg border border-ink/10 bg-white/72 p-5 transition duration-300 hover:-translate-y-1 hover:border-aqua/35 hover:bg-white"
              >
